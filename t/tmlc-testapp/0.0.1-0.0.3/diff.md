# Comparing `tmp/tmlc-testapp-0.0.1.tar.gz` & `tmp/tmlc-testapp-0.0.3.tar.gz`
...
## Comparing `tmlc-testapp-0.0.1.tar` & `tmlc-testapp-0.0.3.tar`
...
### Comparing `tmlc-testapp-0.0.1/LICENSE` & `tmlc-testapp-0.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `tmlc-testapp-0.0.1/pyproject.toml` & `tmlc-testapp-0.0.3/pyproject.toml`
