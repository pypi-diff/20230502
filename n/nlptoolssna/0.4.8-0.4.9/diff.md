# Comparing `tmp/nlptoolssna-0.4.8.tar.gz` & `tmp/nlptoolssna-0.4.9.tar.gz`
...
### Comparing `nlptoolssna-0.4.8/nlptools/morphology/tokenizers_words.py` & `nlptoolssna-0.4.9/nlptools/morphology/tokenizers_words.py`
