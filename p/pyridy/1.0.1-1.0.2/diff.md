# Comparing `tmp/pyridy-1.0.1.tar.gz` & `tmp/pyridy-1.0.2.tar.gz`
...
### Comparing `pyridy-1.0.1/LICENSE` & `pyridy-1.0.2/LICENSE`
...
### Comparing `pyridy-1.0.1/PKG-INFO` & `pyridy-1.0.2/PKG-INFO`
