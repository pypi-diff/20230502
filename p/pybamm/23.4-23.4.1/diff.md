# Comparing `tmp/pybamm-23.4.tar.gz` & `tmp/pybamm-23.4.1.tar.gz`
...
### Comparing `pybamm-23.4/CMakeBuild.py` & `pybamm-23.4.1/CMakeBuild.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/LICENSE.txt` & `pybamm-23.4.1/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/PKG-INFO` & `pybamm-23.4.1/PKG-INFO`
...
### Comparing `pybamm-23.4/README.md` & `pybamm-23.4.1/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/CITATIONS.txt` & `pybamm-23.4.1/pybamm/CITATIONS.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/__init__.py` & `pybamm-23.4.1/pybamm/__init__.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/batch_study.py` & `pybamm-23.4.1/pybamm/batch_study.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/callbacks.py` & `pybamm-23.4.1/pybamm/callbacks.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/discretisations/discretisation.py` & `pybamm-23.4.1/pybamm/discretisations/discretisation.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/doc_utils.py` & `pybamm-23.4.1/pybamm/doc_utils.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/experiments/experiment.py` & `pybamm-23.4.1/pybamm/experiments/experiment.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/array.py` & `pybamm-23.4.1/pybamm/expression_tree/array.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/averages.py` & `pybamm-23.4.1/pybamm/expression_tree/averages.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/binary_operators.py` & `pybamm-23.4.1/pybamm/expression_tree/binary_operators.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/broadcasts.py` & `pybamm-23.4.1/pybamm/expression_tree/broadcasts.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/concatenations.py` & `pybamm-23.4.1/pybamm/expression_tree/concatenations.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/exceptions.py` & `pybamm-23.4.1/pybamm/expression_tree/exceptions.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/functions.py` & `pybamm-23.4.1/pybamm/expression_tree/functions.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/independent_variable.py` & `pybamm-23.4.1/pybamm/expression_tree/independent_variable.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/input_parameter.py` & `pybamm-23.4.1/pybamm/expression_tree/input_parameter.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/interpolant.py` & `pybamm-23.4.1/pybamm/expression_tree/interpolant.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/matrix.py` & `pybamm-23.4.1/pybamm/expression_tree/matrix.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/operations/convert_to_casadi.py` & `pybamm-23.4.1/pybamm/expression_tree/operations/convert_to_casadi.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/operations/evaluate_python.py` & `pybamm-23.4.1/pybamm/expression_tree/operations/evaluate_python.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/operations/jacobian.py` & `pybamm-23.4.1/pybamm/expression_tree/operations/jacobian.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/operations/latexify.py` & `pybamm-23.4.1/pybamm/expression_tree/operations/latexify.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/operations/unpack_symbols.py` & `pybamm-23.4.1/pybamm/expression_tree/operations/unpack_symbols.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/parameter.py` & `pybamm-23.4.1/pybamm/expression_tree/parameter.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/printing/print_name.py` & `pybamm-23.4.1/pybamm/expression_tree/printing/print_name.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/printing/sympy_overrides.py` & `pybamm-23.4.1/pybamm/expression_tree/printing/sympy_overrides.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/scalar.py` & `pybamm-23.4.1/pybamm/expression_tree/scalar.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/state_vector.py` & `pybamm-23.4.1/pybamm/expression_tree/state_vector.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/symbol.py` & `pybamm-23.4.1/pybamm/expression_tree/symbol.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/unary_operators.py` & `pybamm-23.4.1/pybamm/expression_tree/unary_operators.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/variable.py` & `pybamm-23.4.1/pybamm/expression_tree/variable.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/expression_tree/vector.py` & `pybamm-23.4.1/pybamm/expression_tree/vector.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/geometry/battery_geometry.py` & `pybamm-23.4.1/pybamm/geometry/battery_geometry.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/geometry/geometry.py` & `pybamm-23.4.1/pybamm/geometry/geometry.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/geometry/standard_spatial_vars.py` & `pybamm-23.4.1/pybamm/geometry/standard_spatial_vars.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Ecker2015/Ecker_1C.csv` & `pybamm-23.4.1/pybamm/input/discharge_data/Ecker2015/Ecker_1C.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Ecker2015/Ecker_5C.csv` & `pybamm-23.4.1/pybamm/input/discharge_data/Ecker2015/Ecker_5C.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Ecker2015/README.md` & `pybamm-23.4.1/pybamm/input/discharge_data/Ecker2015/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/0.1C_discharge_U.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/0.1C_discharge_U.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/0.1C_discharge_displacement.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/0.1C_discharge_displacement.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/0.5C_discharge_T.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/0.5C_discharge_T.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/0.5C_discharge_U.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/0.5C_discharge_U.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/0.5C_discharge_displacement.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/0.5C_discharge_displacement.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/1C_discharge_T.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/1C_discharge_T.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/1C_discharge_U.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/1C_discharge_U.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/1C_discharge_displacement.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/1C_discharge_displacement.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/2C_discharge_T.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/2C_discharge_T.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/2C_discharge_U.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/2C_discharge_U.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/2C_discharge_displacement.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/2C_discharge_displacement.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/README.md` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/stn_2C.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/stn_2C.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/discharge_data/Enertech_cells/stp_2C.txt` & `pybamm-23.4.1/pybamm/input/discharge_data/Enertech_cells/stp_2C.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/drive_cycles/UDDS.csv` & `pybamm-23.4.1/pybamm/input/drive_cycles/UDDS.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/drive_cycles/US06.csv` & `pybamm-23.4.1/pybamm/input/drive_cycles/US06.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/drive_cycles/WLTC.csv` & `pybamm-23.4.1/pybamm/input/drive_cycles/WLTC.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/ecm/data/ecm_example_c1.csv` & `pybamm-23.4.1/pybamm/input/parameters/ecm/data/ecm_example_c1.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/ecm/data/ecm_example_dudt.csv` & `pybamm-23.4.1/pybamm/input/parameters/ecm/data/ecm_example_dudt.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/ecm/data/ecm_example_ocv.csv` & `pybamm-23.4.1/pybamm/input/parameters/ecm/data/ecm_example_ocv.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/ecm/data/ecm_example_r0.csv` & `pybamm-23.4.1/pybamm/input/parameters/ecm/data/ecm_example_r0.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/ecm/data/ecm_example_r1.csv` & `pybamm-23.4.1/pybamm/input/parameters/ecm/data/ecm_example_r1.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/ecm/example_set.py` & `pybamm-23.4.1/pybamm/input/parameters/ecm/example_set.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lead_acid/Sulzer2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lead_acid/Sulzer2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/Ai2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/Ai2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/Chen2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/Chen2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/Chen2020_composite.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/Chen2020_composite.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/Ecker2015.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/Ecker2015.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/Marquis2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/Marquis2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/Mohtat2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/Mohtat2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/NCA_Kim2011.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/NCA_Kim2011.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/OKane2022.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/OKane2022.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/ORegan2022.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/ORegan2022.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/Prada2013.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/Prada2013.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/Ramadass2004.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/Ramadass2004.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/Xu2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/Xu2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/graphite_LGM50_ocp_Chen2020.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/graphite_LGM50_ocp_Chen2020.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/graphite_ocp_Ecker2015.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/graphite_ocp_Ecker2015.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/graphite_ocp_Enertech_Ai2020.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/graphite_ocp_Enertech_Ai2020.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/lico2_data_example.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/lico2_data_example.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/lico2_ocp_Ai2020.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/lico2_ocp_Ai2020.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/measured_graphite_diffusivity_Ecker2015.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/measured_graphite_diffusivity_Ecker2015.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/measured_nco_diffusivity_Ecker2015.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/measured_nco_diffusivity_Ecker2015.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/nca_ocp_Kim2011_data.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/nca_ocp_Kim2011_data.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/nco_ocp_Ecker2015.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/nco_ocp_Ecker2015.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/data/nmc_LGM50_ocp_Chen2020.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/data/nmc_LGM50_ocp_Chen2020.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/cells/Enertech_Ai2020/README.md` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/cells/Enertech_Ai2020/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/cells/Enertech_Ai2020/parameters.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/cells/Enertech_Ai2020/parameters.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_TDF_EC_DMC_1_1_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_TDF_EC_DMC_1_1_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_base_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_base_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_conductivity_EC_DMC_1_1_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_conductivity_EC_DMC_1_1_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_diffusivity_EC_DMC_1_1_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_diffusivity_EC_DMC_1_1_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_transference_number_EC_DMC_1_1_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/electrolyte_transference_number_EC_DMC_1_1_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/parameters.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_DMC_1_1_Landesfeind2019/parameters.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_TDF_EC_EMC_3_7_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_TDF_EC_EMC_3_7_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_base_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_base_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_conductivity_EC_EMC_3_7_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_conductivity_EC_EMC_3_7_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_diffusivity_EC_EMC_3_7_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_diffusivity_EC_EMC_3_7_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_transference_number_EC_EMC_3_7_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/electrolyte_transference_number_EC_EMC_3_7_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/parameters.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EC_EMC_3_7_Landesfeind2019/parameters.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_TDF_EMC_FEC_19_1_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_TDF_EMC_FEC_19_1_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_base_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_base_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_conductivity_EMC_FEC_19_1_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_conductivity_EMC_FEC_19_1_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_diffusivity_EMC_FEC_19_1_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_diffusivity_EMC_FEC_19_1_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_transference_number_EMC_FEC_19_1_Landesfeind2019.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/electrolyte_transference_number_EMC_FEC_19_1_Landesfeind2019.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/parameters.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_EMC_FEC_19_1_Landesfeind2019/parameters.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_Enertech_Ai2020/README.md` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_Enertech_Ai2020/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_Enertech_Ai2020/dlnf_dlnc_Ai2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_Enertech_Ai2020/dlnf_dlnc_Ai2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_Enertech_Ai2020/electrolyte_conductivity_Ai2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_Enertech_Ai2020/electrolyte_conductivity_Ai2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_Enertech_Ai2020/electrolyte_diffusivity_Ai2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/electrolytes/lipf6_Enertech_Ai2020/electrolyte_diffusivity_Ai2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/experiments/1C_discharge_from_full_Ai2020/README.md` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/experiments/1C_discharge_from_full_Ai2020/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/experiments/1C_discharge_from_full_Ai2020/parameters.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/experiments/1C_discharge_from_full_Ai2020/parameters.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/README.md` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_cracking_rate_Ai2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_cracking_rate_Ai2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_diffusivity_Dualfoil1998.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_diffusivity_Dualfoil1998.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_electrolyte_exchange_current_density_Dualfoil1998.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_electrolyte_exchange_current_density_Dualfoil1998.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_entropy_Enertech_Ai2020.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_entropy_Enertech_Ai2020.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_entropy_Enertech_Ai2020_function.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_entropy_Enertech_Ai2020_function.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_ocp_Enertech_Ai2020.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_ocp_Enertech_Ai2020.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_ocp_Enertech_Ai2020_function.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_ocp_Enertech_Ai2020_function.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_volume_change_Ai2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/graphite_volume_change_Ai2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/parameters.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/negative_electrodes/graphite_Ai2020/parameters.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/README.md` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_cracking_rate_Ai2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_cracking_rate_Ai2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_diffusivity_Dualfoil1998.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_diffusivity_Dualfoil1998.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_electrolyte_exchange_current_density_Dualfoil1998.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_electrolyte_exchange_current_density_Dualfoil1998.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_entropic_change_Ai2020_function.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_entropic_change_Ai2020_function.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_ocp_Ai2020.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_ocp_Ai2020.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_ocp_Ai2020_function.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_ocp_Ai2020_function.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_volume_change_Ai2020.py` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/lico2_volume_change_Ai2020.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/parameters.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/positive_electrodes/lico2_Ai2020/parameters.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/seis/example/README.md` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/seis/example/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/seis/example/parameters.csv` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/seis/example/parameters.csv`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/input/parameters/lithium_ion/testing_only/separators/separator_Ai2020/README.md` & `pybamm-23.4.1/pybamm/input/parameters/lithium_ion/testing_only/separators/separator_Ai2020/README.md`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/install_odes.py` & `pybamm-23.4.1/pybamm/install_odes.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/logger.py` & `pybamm-23.4.1/pybamm/logger.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/meshes/meshes.py` & `pybamm-23.4.1/pybamm/meshes/meshes.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/meshes/one_dimensional_submeshes.py` & `pybamm-23.4.1/pybamm/meshes/one_dimensional_submeshes.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/meshes/scikit_fem_submeshes.py` & `pybamm-23.4.1/pybamm/meshes/scikit_fem_submeshes.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/meshes/zero_dimensional_submesh.py` & `pybamm-23.4.1/pybamm/meshes/zero_dimensional_submesh.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/base_model.py` & `pybamm-23.4.1/pybamm/models/base_model.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/event.py` & `pybamm-23.4.1/pybamm/models/event.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/base_battery_model.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/base_battery_model.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/equivalent_circuit/ecm_model_options.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/equivalent_circuit/ecm_model_options.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/equivalent_circuit/thevenin.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/equivalent_circuit/thevenin.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lead_acid/base_lead_acid_model.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lead_acid/base_lead_acid_model.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lead_acid/basic_full.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lead_acid/basic_full.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lead_acid/full.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lead_acid/full.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lead_acid/loqs.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lead_acid/loqs.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/__init__.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/__init__.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/base_lithium_ion_model.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/base_lithium_ion_model.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/basic_dfn.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/basic_dfn.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/basic_dfn_composite.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/basic_dfn_composite.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/basic_dfn_half_cell.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/basic_dfn_half_cell.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/basic_spm.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/basic_spm.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/dfn.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/dfn.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/electrode_soh.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/electrode_soh.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/electrode_soh_half_cell.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/electrode_soh_half_cell.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/mpm.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/mpm.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/newman_tobias.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/newman_tobias.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/spm.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/spm.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/full_battery_models/lithium_ion/spme.py` & `pybamm-23.4.1/pybamm/models/full_battery_models/lithium_ion/spme.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/active_material/base_active_material.py` & `pybamm-23.4.1/pybamm/models/submodels/active_material/base_active_material.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/active_material/constant_active_material.py` & `pybamm-23.4.1/pybamm/models/submodels/active_material/constant_active_material.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/active_material/loss_active_material.py` & `pybamm-23.4.1/pybamm/models/submodels/active_material/loss_active_material.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/active_material/total_active_material.py` & `pybamm-23.4.1/pybamm/models/submodels/active_material/total_active_material.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/base_submodel.py` & `pybamm-23.4.1/pybamm/models/submodels/base_submodel.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/convection/base_convection.py` & `pybamm-23.4.1/pybamm/models/submodels/convection/base_convection.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/convection/through_cell/base_through_cell_convection.py` & `pybamm-23.4.1/pybamm/models/submodels/convection/through_cell/base_through_cell_convection.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/convection/through_cell/explicit_convection.py` & `pybamm-23.4.1/pybamm/models/submodels/convection/through_cell/explicit_convection.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/convection/through_cell/full_convection.py` & `pybamm-23.4.1/pybamm/models/submodels/convection/through_cell/full_convection.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/convection/through_cell/no_convection.py` & `pybamm-23.4.1/pybamm/models/submodels/convection/through_cell/no_convection.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/convection/transverse/base_transverse_convection.py` & `pybamm-23.4.1/pybamm/models/submodels/convection/transverse/base_transverse_convection.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/convection/transverse/full_convection.py` & `pybamm-23.4.1/pybamm/models/submodels/convection/transverse/full_convection.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/convection/transverse/no_convection.py` & `pybamm-23.4.1/pybamm/models/submodels/convection/transverse/no_convection.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/convection/transverse/uniform_convection.py` & `pybamm-23.4.1/pybamm/models/submodels/convection/transverse/uniform_convection.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/current_collector/base_current_collector.py` & `pybamm-23.4.1/pybamm/models/submodels/current_collector/base_current_collector.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/current_collector/effective_resistance_current_collector.py` & `pybamm-23.4.1/pybamm/models/submodels/current_collector/effective_resistance_current_collector.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/current_collector/homogeneous_current_collector.py` & `pybamm-23.4.1/pybamm/models/submodels/current_collector/homogeneous_current_collector.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/current_collector/potential_pair.py` & `pybamm-23.4.1/pybamm/models/submodels/current_collector/potential_pair.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrode/base_electrode.py` & `pybamm-23.4.1/pybamm/models/submodels/electrode/base_electrode.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrode/ohm/base_ohm.py` & `pybamm-23.4.1/pybamm/models/submodels/electrode/ohm/base_ohm.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrode/ohm/composite_ohm.py` & `pybamm-23.4.1/pybamm/models/submodels/electrode/ohm/composite_ohm.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrode/ohm/full_ohm.py` & `pybamm-23.4.1/pybamm/models/submodels/electrode/ohm/full_ohm.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrode/ohm/leading_ohm.py` & `pybamm-23.4.1/pybamm/models/submodels/electrode/ohm/leading_ohm.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrode/ohm/li_metal.py` & `pybamm-23.4.1/pybamm/models/submodels/electrode/ohm/li_metal.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrode/ohm/surface_form_ohm.py` & `pybamm-23.4.1/pybamm/models/submodels/electrode/ohm/surface_form_ohm.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_conductivity/base_electrolyte_conductivity.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_conductivity/base_electrolyte_conductivity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_conductivity/composite_conductivity.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_conductivity/composite_conductivity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_conductivity/full_conductivity.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_conductivity/full_conductivity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_conductivity/integrated_conductivity.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_conductivity/integrated_conductivity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_conductivity/leading_order_conductivity.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_conductivity/leading_order_conductivity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_conductivity/surface_potential_form/composite_surface_form_conductivity.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_conductivity/surface_potential_form/composite_surface_form_conductivity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_conductivity/surface_potential_form/explicit_surface_form_conductivity.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_conductivity/surface_potential_form/explicit_surface_form_conductivity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_conductivity/surface_potential_form/full_surface_form_conductivity.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_conductivity/surface_potential_form/full_surface_form_conductivity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_conductivity/surface_potential_form/leading_surface_form_conductivity.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_conductivity/surface_potential_form/leading_surface_form_conductivity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_diffusion/base_electrolyte_diffusion.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_diffusion/base_electrolyte_diffusion.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_diffusion/constant_concentration.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_diffusion/constant_concentration.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_diffusion/full_diffusion.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_diffusion/full_diffusion.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/electrolyte_diffusion/leading_order_diffusion.py` & `pybamm-23.4.1/pybamm/models/submodels/electrolyte_diffusion/leading_order_diffusion.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/equivalent_circuit_elements/ocv_element.py` & `pybamm-23.4.1/pybamm/models/submodels/equivalent_circuit_elements/ocv_element.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/equivalent_circuit_elements/rc_element.py` & `pybamm-23.4.1/pybamm/models/submodels/equivalent_circuit_elements/rc_element.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/equivalent_circuit_elements/resistor_element.py` & `pybamm-23.4.1/pybamm/models/submodels/equivalent_circuit_elements/resistor_element.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/equivalent_circuit_elements/thermal.py` & `pybamm-23.4.1/pybamm/models/submodels/equivalent_circuit_elements/thermal.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/equivalent_circuit_elements/voltage_model.py` & `pybamm-23.4.1/pybamm/models/submodels/equivalent_circuit_elements/voltage_model.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/external_circuit/base_external_circuit.py` & `pybamm-23.4.1/pybamm/models/submodels/external_circuit/base_external_circuit.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/external_circuit/explicit_control_external_circuit.py` & `pybamm-23.4.1/pybamm/models/submodels/external_circuit/explicit_control_external_circuit.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/external_circuit/function_control_external_circuit.py` & `pybamm-23.4.1/pybamm/models/submodels/external_circuit/function_control_external_circuit.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/base_interface.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/base_interface.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/interface_utilisation/base_utilisation.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/interface_utilisation/base_utilisation.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/interface_utilisation/constant_utilisation.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/interface_utilisation/constant_utilisation.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/interface_utilisation/current_driven_utilisation.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/interface_utilisation/current_driven_utilisation.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/interface_utilisation/full_utilisation.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/interface_utilisation/full_utilisation.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/__init__.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/__init__.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/base_kinetics.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/base_kinetics.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/butler_volmer.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/butler_volmer.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/diffusion_limited.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/diffusion_limited.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/inverse_kinetics/inverse_butler_volmer.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/inverse_kinetics/inverse_butler_volmer.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/linear.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/linear.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/marcus.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/marcus.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/no_reaction.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/no_reaction.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/tafel.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/tafel.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/kinetics/total_main_kinetics.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/kinetics/total_main_kinetics.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/lithium_plating/base_plating.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/lithium_plating/base_plating.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/lithium_plating/no_plating.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/lithium_plating/no_plating.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/lithium_plating/plating.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/lithium_plating/plating.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/open_circuit_potential/base_ocp.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/open_circuit_potential/base_ocp.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/open_circuit_potential/current_sigmoid_ocp.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/open_circuit_potential/current_sigmoid_ocp.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/open_circuit_potential/single_ocp.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/open_circuit_potential/single_ocp.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/sei/base_sei.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/sei/base_sei.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/sei/constant_sei.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/sei/constant_sei.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/sei/no_sei.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/sei/no_sei.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/sei/sei_growth.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/sei/sei_growth.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/sei/total_sei.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/sei/total_sei.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/interface/total_interfacial_current.py` & `pybamm-23.4.1/pybamm/models/submodels/interface/total_interfacial_current.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/oxygen_diffusion/base_oxygen_diffusion.py` & `pybamm-23.4.1/pybamm/models/submodels/oxygen_diffusion/base_oxygen_diffusion.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/oxygen_diffusion/full_oxygen_diffusion.py` & `pybamm-23.4.1/pybamm/models/submodels/oxygen_diffusion/full_oxygen_diffusion.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/oxygen_diffusion/leading_oxygen_diffusion.py` & `pybamm-23.4.1/pybamm/models/submodels/oxygen_diffusion/leading_oxygen_diffusion.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/oxygen_diffusion/no_oxygen.py` & `pybamm-23.4.1/pybamm/models/submodels/oxygen_diffusion/no_oxygen.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/particle/base_particle.py` & `pybamm-23.4.1/pybamm/models/submodels/particle/base_particle.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/particle/fickian_diffusion.py` & `pybamm-23.4.1/pybamm/models/submodels/particle/fickian_diffusion.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/particle/polynomial_profile.py` & `pybamm-23.4.1/pybamm/models/submodels/particle/polynomial_profile.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/particle/total_particle_concentration.py` & `pybamm-23.4.1/pybamm/models/submodels/particle/total_particle_concentration.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/particle/x_averaged_polynomial_profile.py` & `pybamm-23.4.1/pybamm/models/submodels/particle/x_averaged_polynomial_profile.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/particle_mechanics/base_mechanics.py` & `pybamm-23.4.1/pybamm/models/submodels/particle_mechanics/base_mechanics.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/particle_mechanics/crack_propagation.py` & `pybamm-23.4.1/pybamm/models/submodels/particle_mechanics/crack_propagation.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/particle_mechanics/no_mechanics.py` & `pybamm-23.4.1/pybamm/models/submodels/particle_mechanics/no_mechanics.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/particle_mechanics/swelling_only.py` & `pybamm-23.4.1/pybamm/models/submodels/particle_mechanics/swelling_only.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/porosity/base_porosity.py` & `pybamm-23.4.1/pybamm/models/submodels/porosity/base_porosity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/porosity/constant_porosity.py` & `pybamm-23.4.1/pybamm/models/submodels/porosity/constant_porosity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/porosity/reaction_driven_porosity.py` & `pybamm-23.4.1/pybamm/models/submodels/porosity/reaction_driven_porosity.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/porosity/reaction_driven_porosity_ode.py` & `pybamm-23.4.1/pybamm/models/submodels/porosity/reaction_driven_porosity_ode.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/thermal/base_thermal.py` & `pybamm-23.4.1/pybamm/models/submodels/thermal/base_thermal.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/thermal/isothermal.py` & `pybamm-23.4.1/pybamm/models/submodels/thermal/isothermal.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/thermal/lumped.py` & `pybamm-23.4.1/pybamm/models/submodels/thermal/lumped.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/thermal/pouch_cell/pouch_cell_1D_current_collectors.py` & `pybamm-23.4.1/pybamm/models/submodels/thermal/pouch_cell/pouch_cell_1D_current_collectors.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/thermal/pouch_cell/pouch_cell_2D_current_collectors.py` & `pybamm-23.4.1/pybamm/models/submodels/thermal/pouch_cell/pouch_cell_2D_current_collectors.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/thermal/x_full.py` & `pybamm-23.4.1/pybamm/models/submodels/thermal/x_full.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/transport_efficiency/base_transport_efficiency.py` & `pybamm-23.4.1/pybamm/models/submodels/transport_efficiency/base_transport_efficiency.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/models/submodels/transport_efficiency/bruggeman_transport_efficiency.py` & `pybamm-23.4.1/pybamm/models/submodels/transport_efficiency/bruggeman_transport_efficiency.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/base_parameters.py` & `pybamm-23.4.1/pybamm/parameters/base_parameters.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/bpx.py` & `pybamm-23.4.1/pybamm/parameters/bpx.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/ecm_parameters.py` & `pybamm-23.4.1/pybamm/parameters/ecm_parameters.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/electrical_parameters.py` & `pybamm-23.4.1/pybamm/parameters/electrical_parameters.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/geometric_parameters.py` & `pybamm-23.4.1/pybamm/parameters/geometric_parameters.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/lead_acid_parameters.py` & `pybamm-23.4.1/pybamm/parameters/lead_acid_parameters.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/lithium_ion_parameters.py` & `pybamm-23.4.1/pybamm/parameters/lithium_ion_parameters.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/parameter_sets.py` & `pybamm-23.4.1/pybamm/parameters/parameter_sets.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/parameter_values.py` & `pybamm-23.4.1/pybamm/parameters/parameter_values.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/process_parameter_data.py` & `pybamm-23.4.1/pybamm/parameters/process_parameter_data.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/size_distribution_parameters.py` & `pybamm-23.4.1/pybamm/parameters/size_distribution_parameters.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/parameters/thermal_parameters.py` & `pybamm-23.4.1/pybamm/parameters/thermal_parameters.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/plotting/dynamic_plot.py` & `pybamm-23.4.1/pybamm/plotting/dynamic_plot.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/plotting/plot.py` & `pybamm-23.4.1/pybamm/plotting/plot.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/plotting/plot2D.py` & `pybamm-23.4.1/pybamm/plotting/plot2D.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/plotting/plot_summary_variables.py` & `pybamm-23.4.1/pybamm/plotting/plot_summary_variables.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/plotting/plot_voltage_components.py` & `pybamm-23.4.1/pybamm/plotting/plot_voltage_components.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/plotting/quick_plot.py` & `pybamm-23.4.1/pybamm/plotting/quick_plot.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/settings.py` & `pybamm-23.4.1/pybamm/settings.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/simulation.py` & `pybamm-23.4.1/pybamm/simulation.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/algebraic_solver.py` & `pybamm-23.4.1/pybamm/solvers/algebraic_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/base_solver.py` & `pybamm-23.4.1/pybamm/solvers/base_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/casadi_algebraic_solver.py` & `pybamm-23.4.1/pybamm/solvers/casadi_algebraic_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/casadi_solver.py` & `pybamm-23.4.1/pybamm/solvers/casadi_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/dummy_solver.py` & `pybamm-23.4.1/pybamm/solvers/dummy_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/idaklu_solver.py` & `pybamm-23.4.1/pybamm/solvers/idaklu_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/jax_bdf_solver.py` & `pybamm-23.4.1/pybamm/solvers/jax_bdf_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/jax_solver.py` & `pybamm-23.4.1/pybamm/solvers/jax_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/lrudict.py` & `pybamm-23.4.1/pybamm/solvers/lrudict.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/processed_variable.py` & `pybamm-23.4.1/pybamm/solvers/processed_variable.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/scikits_dae_solver.py` & `pybamm-23.4.1/pybamm/solvers/scikits_dae_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/scikits_ode_solver.py` & `pybamm-23.4.1/pybamm/solvers/scikits_ode_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/scipy_solver.py` & `pybamm-23.4.1/pybamm/solvers/scipy_solver.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/solvers/solution.py` & `pybamm-23.4.1/pybamm/solvers/solution.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/spatial_methods/finite_volume.py` & `pybamm-23.4.1/pybamm/spatial_methods/finite_volume.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/spatial_methods/scikit_finite_element.py` & `pybamm-23.4.1/pybamm/spatial_methods/scikit_finite_element.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/spatial_methods/spatial_method.py` & `pybamm-23.4.1/pybamm/spatial_methods/spatial_method.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/spatial_methods/spectral_volume.py` & `pybamm-23.4.1/pybamm/spatial_methods/spectral_volume.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/spatial_methods/zero_dimensional_method.py` & `pybamm-23.4.1/pybamm/spatial_methods/zero_dimensional_method.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm/util.py` & `pybamm-23.4.1/pybamm/util.py`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm.egg-info/PKG-INFO` & `pybamm-23.4.1/pybamm.egg-info/PKG-INFO`
...
### Comparing `pybamm-23.4/pybamm.egg-info/SOURCES.txt` & `pybamm-23.4.1/pybamm.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/pybamm.egg-info/entry_points.txt` & `pybamm-23.4.1/pybamm.egg-info/entry_points.txt`

 * *Files identical despite different names*

### Comparing `pybamm-23.4/setup.py` & `pybamm-23.4.1/setup.py`
