# Comparing `tmp/autosrt-1.2.4.tar.gz` & `tmp/autosrt-1.2.6.tar.gz`
...
## Comparing `autosrt-1.2.4.tar` & `autosrt-1.2.6.tar`
...
### Comparing `autosrt-1.2.4/LICENSE` & `autosrt-1.2.6/LICENSE`

 * *Files identical despite different names*

### Comparing `autosrt-1.2.4/PKG-INFO` & `autosrt-1.2.6/PKG-INFO`
...
### Comparing `autosrt-1.2.4/README.md` & `autosrt-1.2.6/README.md`

 * *Files identical despite different names*

### Comparing `autosrt-1.2.4/autosrt/__init__.py` & `autosrt-1.2.6/autosrt/__init__.py`
...
### Comparing `autosrt-1.2.4/autosrt/autosrt.py` & `autosrt-1.2.6/autosrt/autosrt.py`
...
### Comparing `autosrt-1.2.4/autosrt.egg-info/PKG-INFO` & `autosrt-1.2.6/autosrt.egg-info/PKG-INFO`
...
### Comparing `autosrt-1.2.4/setup.py` & `autosrt-1.2.6/setup.py`
...
### Comparing `autosrt-1.2.4/test/test1.py` & `autosrt-1.2.6/test/test1.py`

 * *Files identical despite different names*

### Comparing `autosrt-1.2.4/test/test2.py` & `autosrt-1.2.6/test/test2.py`
