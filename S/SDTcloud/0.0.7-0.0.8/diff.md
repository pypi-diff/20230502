# Comparing `tmp/SDTcloud-0.0.7.tar.gz` & `tmp/SDTcloud-0.0.8.tar.gz`
...
## Comparing `SDTcloud-0.0.7.tar` & `SDTcloud-0.0.8.tar`
...
### Comparing `SDTcloud-0.0.7/SDTcloud/sdtcloud.py` & `SDTcloud-0.0.8/SDTcloud/sdtcloud.py`

 * *Files identical despite different names*

### Comparing `SDTcloud-0.0.7/setup.py` & `SDTcloud-0.0.8/setup.py`
